...
import type { StudentOfferLocation } from '../hooks/useStudentOfferLocation';
...
interface InternshipOffersSearchToolbarProps {
  ...
  studentLocation: StudentOfferLocation;
...
const InternshipOffersSearchToolbar: FunctionComponent<InternshipOffersSearchToolbarProps> = ({
  ...
  const locationHintKey =
    studentLocation.source === 'gps'
      ? 'student.internshipOffers.filters.locationGps'
      : studentLocation.source === 'profile'
        ? 'student.internshipOffers.filters.locationProfile'
        : 'student.internshipOffers.filters.locationMissing';
    ...
    >
      <div className="admin-ann-feed__hero">
        ...
        {filtersOpen ? (
          ...
          >
            <div className="student-internship-feed__location-banner">
              <MapPin className="h-4 w-4 shrink-0 text-[var(--admin-brand)]" aria-hidden />
              <span>
                {t(locationHintKey, {
                  city: studentLocation.label ?? '',
                })}
              </span>
            </div>
