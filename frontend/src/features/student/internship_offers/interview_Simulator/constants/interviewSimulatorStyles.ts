...
export const IS_WELCOME_CARD = 'admin-module-panel flex flex-col gap-3 p-5 sm:p-6';

export const IS_ACTIONS_SECTION = 'admin-module-panel mt-4 p-4 sm:p-5';

export const IS_ACTIONS_INNER = 'flex w-full min-w-0 flex-col gap-2 sm:flex-row sm:flex-wrap';
