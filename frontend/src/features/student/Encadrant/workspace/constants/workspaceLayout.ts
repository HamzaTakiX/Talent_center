export const WORKSPACE_PAGE_ROOT =
  'student-workspace-platform mx-auto flex w-full min-w-0 max-w-[1680px] flex-col gap-5 scroll-mt-4 pb-8 font-inter sm:gap-6';

export const WORKSPACE_GLASS_CARD =
...
export const WORKSPACE_WHITEBOARD_INNER =
  'relative min-h-[400px] w-full p-4 sm:p-6';
