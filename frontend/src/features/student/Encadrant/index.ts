export { default as EncadrantPage } from './pages/EncadrantPage';
export { ChatPage as EncadrantChatPage } from './chat';
...
export { MeetingsPage as EncadrantMeetingsPage } from './meetings';
