      ...
      >
        <div className="flex min-h-0 flex-1 overflow-hidden bg-white">
          ...
          >
            {selectedConv ? (
              <>
                <div className="relative z-[1] shrink-0 border-b border-solid border-neutral-200 bg-white">
                  <div className="flex min-h-[2.875rem] items-center justify-between gap-2 px-3 sm:gap-3 sm:px-4">
                    ...
                    <div className="flex shrink-0 items-center gap-0.5 self-center">{chatTools.menu}</div>
                  </div>
                  {chatTools.searchBar}
                </div>

                <div ref={scrollRef} className="isi-messages min-h-0 flex-1 overflow-y-auto">
                  <StandardChatMessageThread
                    messages={thread}
                    inboxMode="admin"
