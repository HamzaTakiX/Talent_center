  ...
  return (
    ...
    >
      ...
      <div className="flex min-w-0 flex-col gap-3">
        <div>
          <p className={REPORTS_VALIDATED_FIELD_LABEL}>{t('encadrant.common.lastReport')}:</p>
        ...
        <div>
          <p className={REPORTS_VALIDATED_FIELD_LABEL}>{t('encadrant.common.nextReport')}:</p>
          ...
          {student.isOverdue ? (
            ...
            <p className={REPORTS_VALIDATED_FIELD_SUB}>
