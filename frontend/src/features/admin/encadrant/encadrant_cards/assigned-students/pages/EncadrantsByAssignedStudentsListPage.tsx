...
const EncadrantsByAssignedStudentsListPage: FunctionComponent = () => {
  ...
  const totalFormatted = encadrantsSummaryStats[1].value.toLocaleString('en-US');
  ...
  return (
    <AdminListPageShell
      ...
      backTo="encadrants"
    >
      <AdminStatChartSection chartId="encadrants-top-assigned" />
      <AdminStatDetailPanel
        title={pageTitle('encadrants.assigned.title', { count: totalFormatted })}
