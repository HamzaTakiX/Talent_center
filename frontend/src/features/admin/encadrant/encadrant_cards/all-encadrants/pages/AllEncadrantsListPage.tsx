...
const AllEncadrantsListPage: FunctionComponent = () => {
  ...
  const totalFormatted = encadrantsSummaryStats[0].value.toLocaleString('en-US');
  ...
  return (
    <AdminListPageShell
      ...
      backTo="encadrants"
    >
      <AdminStatChartSection chartId="encadrants-department-load" />
      <AdminStatDetailPanel
        title={pageTitle('encadrants.all.title', { count: totalFormatted })}
