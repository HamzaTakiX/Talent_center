...
import type { DraftOfferListRow } from '../data/draftOffersOnlyMockData';
...
interface DraftOffersListTableContentProps {
  offers: DraftOfferListRow[];
}

const DraftOffersListTableContent: FunctionComponent<DraftOffersListTableContentProps> = ({
  offers,
}) => {
...
export default DraftOffersListTableContent;
