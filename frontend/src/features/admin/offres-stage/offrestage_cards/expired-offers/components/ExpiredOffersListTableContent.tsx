...
interface ExpiredOffersListTableContentProps {
  offers: ExpiredOfferListRow[];
}

const ExpiredOffersListTableContent: FunctionComponent<ExpiredOffersListTableContentProps> = ({
  offers,
}) => {
...
export default ExpiredOffersListTableContent;
