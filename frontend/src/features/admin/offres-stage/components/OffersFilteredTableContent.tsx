...
const OffersFilteredTableContent: FunctionComponent<OffersFilteredTableContentProps> = ({
  ...
  return (
    <>
      <div className="admin-offers-mobile-list space-y-3 px-3 pb-5 pt-0 sm:px-6 sm:pb-6">
        {offers.length === 0 ? (
      ...
      <div className="admin-module-table-wrap admin-offers-table-wrap admin-offers-table-wrap--desktop-only">
