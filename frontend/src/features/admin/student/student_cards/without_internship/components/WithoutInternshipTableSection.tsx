...
import type { WithoutInternshipTableRow } from '../data/withoutInternshipTableRows';
...
interface WithoutInternshipTableSectionProps {
  students: WithoutInternshipTableRow[];
  query: string;
...
const WithoutInternshipTableSection: FunctionComponent<WithoutInternshipTableSectionProps> = ({
  students,
  query,
  onQueryChange,
  fieldFilter,
...
export default WithoutInternshipTableSection;
