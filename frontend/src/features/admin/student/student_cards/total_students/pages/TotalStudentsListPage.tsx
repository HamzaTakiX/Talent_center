...
import TotalStudentsStatGrid from '../components/TotalStudentsStatGrid';
import TotalStudentsTableSection from '../components/TotalStudentsTableSection';
import { totalStudentsTableRows } from '../data/totalStudentsTableRows';
...
const TotalStudentsListPage: FunctionComponent = () => {
  ...
  return (
    <AdminListPageShell
      ...
      backTo="students"
    >
      <TotalStudentsStatGrid />
      <AdminStatChartSection chartId="students-total-enrollment" />
