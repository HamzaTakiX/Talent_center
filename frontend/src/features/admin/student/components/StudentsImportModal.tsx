...
import type { StudentImportResult } from '../../api/types';
...
const TEMPLATE_CSV = [
  'email,first_name,last_name,student_number,filiere_code,class_group_code,academic_year,sso_enabled,grant_access',
  'student1@example.com,Jean,Dupont,STU-001,pge,pge-y1-a-2025-2026,2025-2026,false,false',
  'student2@example.com,Marie,Martin,STU-002,lme,lme-y3-gcf-a-2025-2026,2025-2026,false,false',
].join('\n');
...
const StudentsImportModal: FunctionComponent<StudentsImportModalProps> = ({
  open,
  onClose,
  onImported,
}) => {
