...
const AnnouncementsTable: FunctionComponent<AnnouncementsTableProps> = ({
  ...
  const { tableColumn, emptyState, announcementTypeLabel } = useAdminCopy();
  ...
  return (
    ...
    >
      <div className="box-border w-full min-w-0 shrink-0 px-4 pb-6 pt-4 sm:px-6">
          ...
          <AdminTableScroll minWidth="880px" className="admin-table-scroll--panel">
            <thead>
              <tr className="box-border h-10 border-b border-solid border-[var(--admin-border)]">
                <th className="box-border py-2.5 pl-2 pr-2 text-start align-middle font-medium leading-num-20">
                  {tableColumn('title')}
                </th>
                <th className="box-border py-2.5 pl-2 pr-2 text-start align-middle font-medium leading-num-20">
                  {tableColumn('type')}
                ...
                <th className="box-border py-2.5 pl-2 pr-2 text-start align-middle font-medium leading-num-20">
                  {tableColumn('targetAudience')}
                </th>
                <th className="box-border py-2.5 pl-2 pr-2 text-start align-middle font-medium leading-num-20">
                  {tableColumn('date')}
                </th>
                <th className="box-border py-2.5 pl-2 pr-2 text-end align-middle font-medium leading-num-20">
                  {tableColumn('actions')}
                </th>
              </tr>
            </thead>
