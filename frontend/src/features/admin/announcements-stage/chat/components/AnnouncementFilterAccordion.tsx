...
import {
  ...
  PRIORITIES,
  PUBLISH_STATUSES,
} from '../data/announcementSupportMock';
import type { AnnouncementInboxFilters } from '../types/announcementChatTypes';
...
const AnnouncementFilterAccordion: FunctionComponent<Props> = ({
  filters,
  hasActiveFilters,
  filterCounts,
  programOptions,
...
export default AnnouncementFilterAccordion;
