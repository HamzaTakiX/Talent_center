...
urlpatterns = [
    ...
    path('feed/<int:notification_id>/click/', views.NotificationClickView.as_view(), name='notification-click'),
    path('stats/', views.NotificationUserStatsView.as_view(), name='notification-user-stats'),
